    ...
    <div class="px-4 pb-10 font-poppins">
        <div class="grid grid-cols-1 gap-4 md:gap-5 lg:grid-cols-3">
            <template x-for="jurusan in filteredJurusan">
                <div class="relative w-full rounded-lg bg-base-100 h-56 lg:h-60 shadow-lg font-poppins">
                    ...
                    <div class="avatar mt-2 ml-2 md:mt-3 md:ml-3">
                        <div class="w-[3.2rem] h-14 md:w-16 rounded-full border border-black">
                    ...
                    <div class="absolute bottom-0 left-0 flex items-center justify-around md:justify-end w-full h-12 px-1 border-t border-gray-400">
                        <div class="lg:tooltip" data-tip="Lihat Kelas">
                            <div class="relative flex items-center justify-center">
                                <a :href="'kelas/' + jurusan.slug" class="py-1 px-5 md:px-2 md:py-2 flex items-center rounded-lg border border-gray-700/30 md:border-0 bg-gray-100 hover:bg-gray-200">
                        ...
                        <div class="lg:tooltip" data-tip="Lihat Nilai">
                            <div class="relative flex items-center justify-center">
                                <a :href="'nilai/' + jurusan.slug" class="py-1 px-5 md:px-2 md:py-2 flex items-center rounded-lg border border-gray-700/30 md:border-0 bg-gray-100 hover:bg-gray-200">
                        ...
                        <div class="lg:tooltip" data-tip="Lihat di Drive">
                            <div class="relative flex items-center justify-center">
                                <a :href="jurusan.slug" class="py-1 px-5 md:px-2 md:py-2 flex items-center rounded-lg border border-gray-700/30 md:border-0 bg-gray-100 hover:bg-gray-200">
