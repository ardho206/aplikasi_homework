            ...
            <div class="bg-white w-full h-full rounded-xl flex flex-col justify-center items-center relative">
                ...
                @else
                    ...
                    <div class="flex gap-3 md:gap-2">
                        <button type="button" onclick="window.location.href='/login'" class="text-white bg-gradient-to-br from-[#5E72E4] to-blue-400 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-6 py-1.5 md:px-8 md:py-2.5 text-center">Login</button>
                        <button type="button" onclick="window.location.href='/register'" class="text-white bg-gradient-to-br from-[#5E72E4] to-blue-400 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-6 py-1.5 md:px-8 md:py-2.5 text-center">Sign Up</button>
                    </div>
                @endif
