    ...
    <nav class="flex flex-col w-full space-y-4 font-montserrat">
        ...
        <div  :class="!sidebarOpen ? 'tooltip tooltip-right' : '' " :data-tip="!sidebarOpen ? 'Beranda' : '' ">
            <a href="" class="flex bg-[#5E72E4] text-white text-lg font-semibold p-4 overflow-hidden rounded-lg relative">
                <svg class="w-6 h-6 absolute top-1/2 -translate-y-1/2 left-[12px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
        ...
        <div  :class="!sidebarOpen ? 'tooltip tooltip-right' : '' " :data-tip="!sidebarOpen ? 'Tugas' : '' ">
            <a href="" class="relative flex p-4 overflow-hidden text-lg font-semibold text-gray-600 rounded-lg bg-neutral-100 hover:bg-neutral-300 hover:text-gray-700">
                <svg class="w-6 h-6 absolute top-1/2 -translate-y-1/2 left-[12px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
        ...
        <div  :class="!sidebarOpen ? 'tooltip tooltip-right' : '' " :data-tip="!sidebarOpen ? 'Siswa' : '' ">
            <a href="" class="relative flex p-4 overflow-hidden text-lg font-semibold text-gray-600 rounded-lg bg-neutral-100 hover:bg-neutral-300 hover:text-gray-700">
                <svg class="w-6 h-6 absolute top-1/2 -translate-y-1/2 left-[12px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 18">
        ...
        <div  :class="!sidebarOpen ? 'tooltip tooltip-right' : '' " :data-tip="!sidebarOpen ? 'Absensi' : '' ">
            <a href="" class="relative flex p-4 overflow-hidden text-lg font-semibold text-gray-600 rounded-lg bg-neutral-100 hover:bg-neutral-300 hover:text-gray-700">
                <svg class="w-6 h-6 absolute top-1/2 -translate-y-1/2 left-[12px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
